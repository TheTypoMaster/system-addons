...
const { LoopCallsInternal } = Cu.import("resource://loop/modules/LoopCalls.jsm", {});
...
function run_test() {
  ...
  const MozLoopServiceInternal = Cu.import("resource://loop/modules/MozLoopService.jsm", {}).MozLoopServiceInternal;
